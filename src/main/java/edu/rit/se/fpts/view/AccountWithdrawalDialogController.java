...
import edu.rit.se.fpts.controller.command.AccountWithdrawalCommand;
...
public class AccountWithdrawalDialogController {
	...
	private void handleMakeWithdrawal() {
		if (validInput()) {
			...
			Command command = new AccountWithdrawalCommand(manager.getModel(), account, amount);
