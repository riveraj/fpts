...
public class BearSimulation implements SimulationStrategy {

	private final static BigDecimal GROWTH_MULTIPLIER = BigDecimal.valueOf(0.5);

	private final BigDecimal initialPrice;
	private final List<String> intervals;

	public BearSimulation(Equity equity, List<String> intervals) {
