...
public class NoGrowthSimulation implements SimulationStrategy {

	private final static BigDecimal GROWTH_MULTIPLIER = BigDecimal.ONE;

	private final BigDecimal initialPrice;
	private final List<String> intervals;

	public NoGrowthSimulation(Equity equity, List<String> intervals) {
